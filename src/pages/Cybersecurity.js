...
import b from '../img/carousel-2.jpg';
import i from '../img/RohitNegi.jpg';
import j from '../img/ShwetaSharma.png';
import z from '../img/ManindraAgarwal.png';
import k from '../img/AnshVaid.jpg';

import r from '../img/course-2.jpg';
...
function Cs() {
    return (<div>
        ...
        <script     src="https://ajax.googleapis.com/ajax/libs/jquery/3.5.1/jquery.min.js"></script>
         ...
         <div className="container-fluid justify-content-center p-0 mb-5">
         ...
         <div className="container-xxl justify-content-center py-5">
             <div className="container">
         ...
         <div className="container-xxl py-5">
             <div className="container">
                 ...
                 <div  >
         <div className="container-xxl center py-5">
             <div className="container ">
                 ...
                 <div className="row g-4 justify-content-center">
                     <div className="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.1s">
                                 ...
                                 <h5 className="mb-4">Cybersecurity Course for Beginners</h5>
                             </div>
                             <div className="d-flex border-top">
                                 <small className="flex-fill text-center border-end py-2"><i className="fa fa-user-tie text-primary me-2"></i>dr. shweta sharma,Mr. Rohit negi,Mr Ansh vaid and many more</small>
                                 <small className="flex-fill text-center border-end py-2"><i className="fa fa-clock text-primary me-2"></i>6 Hrs per week</small>
         ...
         <span className="sr-only">Next</span>
                 ...
                 <div className="row g-4">
                     <div className="col-lg-3 col-md-6 wow fadeInUp" data-wow-delay="0.1s">
                         <div className="team-item bg-light">
                             <div className="overflow-hidden">
                                 <img className="img-fluid" src={i} style={{height:"250px"}}/>
                                                         </div>
                             ...
                             <div className="text-center p-4">
                                 <h5 className="mb-0">Mr. Rohit negi</h5>
                                 <small>Senior vice president(R&D) IIT Kanpur</small>
                             </div>
                         </div>
                     </div>
                     <div className="col-lg-3 col-md-6 wow fadeInUp" data-wow-delay="0.3s">
                         <div className="team-item bg-light">
                             <div className="overflow-hidden">
                                 <img className="img-fluid" src={j} style={{height:"250px"}} alt=""/>
                             </div>
                             <div className="position-relative d-flex justify-content-center" >
                                 <div className="bg-light d-flex justify-content-center pt-2 px-1">
                                     <a className="btn btn-sm-square btn-primary mx-1" href=""><i className="fab fa-facebook-f"></i></a>
                             ...
                             <div className="text-center p-4">
                                 <h5 className="mb-0">ShwetaSharma</h5>
                                 <small>Assistant professor CSE,punjab engineering college</small>
                             </div>
                         </div>
                     </div>
                     <div className="col-lg-3 col-md-6 wow fadeInUp" data-wow-delay="0.5s">
                         <div className="team-item bg-light">
                             <div className="overflow-hidden">
                                 <img className="img-fluid" src={z} style={{height:"250px"}} alt=""/>
                             </div>
                             <div className="position-relative d-flex justify-content-center" >
                                 <div className="bg-light d-flex justify-content-center pt-2 px-1">
                                     <a className="btn btn-sm-square btn-primary mx-1" href=""><i className="fab fa-facebook-f"></i></a>
                             ...
                             <div className="text-center p-4">
                                 <h5 className="mb-0">Maninder aggrawal</h5>
                                 <small>Professor department CSE</small>
                             </div>
                         </div>
                     </div>
