...
import d from '../assets/assets/images/heading-line-dec.png';
import e from '../assets/assets/images/about-right-dec.png';
import f from '../assets/assets/images/heading-line-dec.png';
import g from '../assets/assets/images/quote.png';

import i from '../assets/assets/images/quote.png';
import h from '../assets/assets/images/client-image.jpg';
import j from '../assets/assets/images/client-image.jpg';
import k from '../assets/assets/images/pricing-table-01.png';
import l from '../assets/images/white-logo.png';
import m from '../assets/images/pricing-table-01.png';
import n from '../assets/assets/images/pricing-table-01.png';
import o from '../assets/assets/images/pricing-table-01.png';
import  '../assets/assets/css/animated.css';
import  '../assets/assets/css/fontawesome.css';
//import  '../assets/assets/css/owl.css';
//import  '../assets/assets/css/templatemo-chain-app-dev.css';
import play from '../img/demo/google play.png';
import r from '../img/demo/C3i-logo.png';
import u from '../img/demo/nasdaq-logo.png';
import t from '../img/demo/partners.jpg';
import s from '../img/demo/Workers.png';
import q from '../img/news/organiser.png';
import p from '../img//news/fox40.jpg';

import v from '../img/news/WRDE.png';
import w from '../img/news/WRDE.png';
...
import aaa from "../assets/img1/news/organiser.png" ;
import y from "../assets/img1//news/tone.png"  ;
import z from "../assets/img1//news/tone.png"  ;
import qa from "../assets/images/logo.png";
import qb from "../assets/images/slider-dec.png";
import qc from "../assets/images/heading-line-dec.png";
import qd from "../assets/images/heading-line-dec.png";
import qe from "../assets/images/about-right-dec.png";
import qf from "../assets/images/heading-line-dec.png";
import qk from "../assets/images/quote.png";
import ql from "../assets/images/client-image.jpg";
import qm from "../assets/images/quote.png";
import qn from "../assets/images/heading-line-dec.png";
import  '../assets/assets/css/animated.css';
...
<a href="https://thecenter.nasdaq.org/" target="new"><img src={b} alt="nasdaq" style={{ width:"50%", height:"11vh"}} className="C  img"/></a>
        <br></br>
        
            <a href="https://siicincubator.com/" target="new"><img src={c} alt="IIT" style={{ width:"50%" ,height:"11vh"}} className="C"/></a>
        <br></br>
       
        <div > <a href="https://c3ihub.org/" target="new"><img src={a} alt="C3i" style={{ width:"50%" ,height:"11vh"}} className="C"/></a></div> 
       
    
                       <a href="https://play.google.com/store/apps/details?id=com.bb.indianmajdoorunion">
                <img src={play} alt="PlayStore"width="20%" height="80vh" className="playstoreImg"/>
            </a>
        </div></div></div>
        <div className='col-2'>
            <p>Worker Union Support - A Product Of Pradivya Software Private Limited
...
<main className="hoc container clear">
    ...
    <section id="introblocks" className="row3 inspace-30 clear">
              ...
              <div className='col-9'> <div className="center ">
            <img src={n} height="280vh" width="120%" alt="worker empowerment"/>
    ...
    <section id="services"><div className='row'><div className='col-4'></div>
        <div className="sectiontitle col-4">
            <h6 className="heading font-x2 center upper "><h5><b>Our Solutions</b></h5></h6>
            <hr/>
        </div></div>
    ...
    <div class="row">
      <div class="col-lg-4">
        ...
        <img src={x} alt="screen1" style={{width:"100%",height:'30vh'}}/>
          <div class="icon"></div>
        ...
        <div class="service-item fourth-service">
          <div class="icon"><img src={kl} alt="screen2" style={{width:"100%",height:"30vh",border: "none"}} /> <div className="title">
                        <b>    Jobs And Skills (Knowledge Sharing)</b>
                        </div>
                        <p>
...
<div class="col-lg-4">
        <div class="service-item second-service">
          <div class="icon"><img src={n} alt="screen5"style={{width:'100%',height:'30vh'}}/>
          </div>
          <h4>Community Build-Up (Group Communication)</h4>
      ...
      <div class="col-lg-6">
        <div class="service-item third-service">
          <div class="icon"></div>
          <img src={o} style={{width:'100%',height:'30vh'}}/>
          <h4>Compensation Calculation (Rule Book)</h4>
          <p>
 ...
 <div class="col-lg-6">
        <div class="service-item third-service">
          <div class="icon"></div>
          <img src={ffk} style={{width:"100%","border": "none",height:'30vh'}} alt="scree3"/>
                      
          <h4> Library And Notifications (Rights & Privileges)</h4>
          <p>
      ...
      <div className='col-4'>    <div className="card center" style={{"border": "none",height:'100%',width:'100%'}}>
                    <div className="img">
        ...
        <div class="col-lg-12">
        <div class="service-item fourth-service">
          <div class="icon"> <img src={k1} style={{width:"100%","border": "none",height:'50vh'}} alt="loan"/>
                 <div className="title">
                            <b>Loans And Credit Support</b>
                             <p>
    ...
    <div className='col-12'>
      <div className="card center" style={{"border": "none",height:'100%',height:'50vh',width:'100%'}}>
                    <div className="img">
                             <div className="content">
  ...
  <div className="card center col-12" style={{"border": "none"}}>
                    <div className="img">
                        <img src={ww} style={{width:"400vw",height:"45vh","border": "none"}} className=' img' alt="sccreen6"/>
                    </div>
                    <div className="content">
                        <div className="title">
...
<div className="wrapper center row3">
<section id="support">
    <div className="space-60 center"></div>
    <div className="container col-8 center">
 
        
        <div className="supporter col-12 center">
            <div >
                <a href="https://www.n-coe.in/" target="new">
                 <img src={aa} alt="Support" style={{height:"5vh",width:"105vh"}} className="center ssupporterDivImg img"/>
                </a>
              </div>
        </div>
...
<div className='row'>
<div className='col-1'></div><div className='col-8'>
...
<section className="hoc container clear Downloadpad">
    <div className="sectiontitle txtLeft">
      ...
      <div className="col-8  "><a href="https://play.google.com/store/apps/details?id=com.bb.indianmajdoorunion" className="btn btn-primary btn-lg btn-block center" style={{"background-color": "#1a2016" ,width:"25vh"}} target="new">Get Started</a></div>
        <h6 className="heading center font-x2 justify-Items-center">DOWNLOAD THE APP FOR MORE UPDATES AND INFORMATION</h6>
    </div>
</section>
</div>
  <div className='container width center' >
        <div className="row wow center fadeInUp container bg-info">
            
                
                <h1 className="text-uppercase center container main-heading txtUpper">WUS In Media</h1>
                ...
                <div className="images imgBorder">
                    <div className="images-inner">
                        ...
                        <div className="image-slide">
                            <div className="image ">
                                <div className="hidden-xs hidden-sm fadeInLeft one_quarter first fadeLeft">
                                    <img src={xx} alt="blog" style={{width:"100%",height:"450px"}} className="wiHi"/>
                                </div>
                                <div className="two_third">
                                    ...
                                    <div className="flex-container-publish row">
                                        ...
                                        <div className="center col-6">
                                            <a href="https://www.mangaloremirror.com/wus-invited-by-nasdaq-entrepreneurial-center/" target="_blank" rel="noopener">
                                                <img src={ee} alt="WUS in news" style={{height:'75px',width:'60vw'}} className="center mediaSizeWiHI img"/></a>
                                        </div>
                                    
                                       
                                            <div className='col-3'> <a href="https://www.organiser.org/Encyc/2020/9/1/The-Goonj-of-PMs-call-for-Aatma-Nirbhar-Bharat-reaches-Nasdaq.html" target="_blank" rel="noopener">
                                                <img src={j} alt="WUS in news" className="mWIHI img"/></a></div>
                                                <div className='col-4'>
                        <div className="image-slide col-4">
...
<div className='row'><div className='col-6'>                                            <a href="https://www.wrde.com/story/43382355/how-nyu-wagner-alum-is-empowering-indian-blue-collar-workers" target="_blank" rel="noopener" className="imgBlue">
                                                <img src={n} alt="WUS in WRDE " style={{height:'60px',width:"65px"}}className="center mHi center img"/></a>
                                        </div>
                                          <div className='center  col-6'>
                                            <a href="https://www.wicz.com/story/43382355/how-nyu-wagner-alum-is-empowering-indian-blue-collar-workers" target="_blank" rel="noopener" className="imgBlue">
                                                <img src={p} alt="WUS in fox40 " style={{height:'50px',width:"65px"}} className="mediaSize center img"/></a>
                                        </div>
                                        <div>
                                    ...
                                    <div className="flex-container-publish">
                                        <div >
                                            <a href="https://www.organiser.org/Encyc/2021/3/31/IIT-Kanpur-startup-WUS-selected-by-Nasdaq-Entrepreneurial-Center.html" target="_blank" rel="noopener" className="imgBlue">
                                                <img src={q} alt="organiser" height="90vh" className="mediaSize"/></a>
                                        </div>
                                    </div>
                                </div>
                               </div>
